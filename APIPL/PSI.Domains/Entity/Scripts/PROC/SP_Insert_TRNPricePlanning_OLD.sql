/****** Object:  StoredProcedure [dbo].[SP_Insert_TRNPricePlanning]    Script Date: 7/14/2023 2:45:29 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN          
 ...
 --TRUNCATE TABLE [dbo].[TRNSalesPlanning];        
  ...
  INSERT INTO @tvpAccounMaterialPricePlannings        
   ...
   where AccountCode IS NOT NULL AND MaterialCode IS NOT NULL AND 
   MonthYear >= @resultMonthYear
